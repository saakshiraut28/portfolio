    ...
    <div className="flex justify-center w-screen h-screen text-black">
      ...
      >
        ...
        <div className="top-[100px] absolute">
          ...
          <div className="px-10 lg:px-20 font-main overflow-y-hidden container para">
            {/* TITLE */}
            ...
            <div className="flex lg:px-20 py-14">
              <span className="space-y-2 auto-type lg:w-2/3 font-regular text-xl md:text-2xl leading-relaxed overflow-hidden intro">
                <p className="pb-3 overflow-hidden para">
                  ...
                  Engineering at Usha Mittal Institute of Technology, situated
                  in Mumbai, India.{" "}
                </p>

                <p className="pb-3 overflow-hidden para">
                  I design and create web applications, contribute to
                  open-source projects, and write about tech.
                </p>
